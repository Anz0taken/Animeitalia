<?php
    ...
    { 
        if(isset($_POST['Contenuto']) && isset($_POST['NomeParametro']))
        {
            ...
            $NomeParametro = filter_input(INPUT_POST, "NomeParametro", FILTER_SANITIZE_FULL_SPECIAL_CHARS, FILTER_FLAG_STRIP_LOW | FILTER_FLAG_STRIP_HIGH);
            ...
            $ArrayUpdate[0]->NomeParametro = $NomeParametro;
